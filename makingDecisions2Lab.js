...
if (score >= 90) {
  console.log ('you got an A! you sure are smart')
} else if (score >= 80) {
  console.log ('you got a B, try better next time')
} else if (score >= 70) {
  console.log ('you got a C, remember Cs get degrees!')
} else if (score >= 60) {
  console.log('you got a D. dont get discouraged')
} else if (score < 60) {
  console.log('Bruh, you totally failed. git gud')
}
...
/* Can't get this to work. Need help. 
switch(letterGrade) {
